...
// entered a real chain and was tried as a chat model.
const TOOLS_IMPOSSIBLE_RE = /(?:embed|embedqa|bge-(?:m3|large|base|small)|gte-(?:large|base|small)|e5-(?:large|base|small)|nomic-embed|jina-embeddings|nemoretriever|nemoguard|nemotron-?safety|safety-?guard|content-?safety|topic-?control|tts|whisper|speech|orpheus|kokoro|parler-?tts|xtts|guard)/i;
...
const TOOLS_UNRELIABLE_RE = /(?:starcoder|jamba|code-?llama|deepseek-?coder|llama-?3\.1-?8b|llama-?2(?!\d))/i;
