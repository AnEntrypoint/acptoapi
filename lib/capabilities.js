...
const INTERNAL_ONLY_TOOL_NAMES_NEVER_EXPOSED = new Set([
...
function stripInternalTools(tools) {
  ...
  for (const tool of tools) {
    ...
    if (INTERNAL_ONLY_TOOL_NAMES_NEVER_EXPOSED.has(name)) {
      stripped.push(name);
    } else {
      kept.push(tool);
    }
...
module.exports = { getCapabilities, stripUnsupported, stripInternalTools, STRIPPED_TOOLS: INTERNAL_ONLY_TOOL_NAMES_NEVER_EXPOSED, DEFAULTS };
