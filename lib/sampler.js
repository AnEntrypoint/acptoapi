...
function createSampler() {
  ...
  function startSampler(getProbes) {
    if (interval) return;
  ...
  return { isAvailable, markFailed, markOk, resetAvailability, getStatus, probe, startSampler, stopSampler };
}
...
module.exports = {
  ...
  startSampler: (fn) => _singleton.startSampler(fn),
