...
const BUILTIN = {
    ...
    // hy3-free on opencode-zen is the PREFERRED (top) model; GLM-5.2 (Cerebras)
    // is the second/ fallback option. Deterministic preferred/second ordering
    // regardless of which other providers are configured.
    'glm-zen':    ['opencode-zen/hy3-free', 'cerebras/zai-org/glm-5.2'],
};
