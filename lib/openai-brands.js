...
const BRANDS = {
  ...
  cloudflare:     { url: () => `https://api.cloudflare.com/client/v4/accounts/${process.env.CLOUDFLARE_ACCOUNT_ID}/ai/v1/chat/completions`, envKey: 'CLOUDFLARE_API_KEY' },
...
function getBrand(prefix) {
  ...
  if (typeof b.url === 'function') return { ...b, url: b.url() };
  return b;
}
