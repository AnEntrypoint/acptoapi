...
const { buildAutoChain, buildAutoChainLive, getOrder } = require('./auto-chain');
...
function createServer({ port = 4800, backends = {}, queuesProvider = null } = {}) {
  ...
  return new Promise((resolve, reject) => {
    server.listen(port, host, () => {
      ...
      if (process.env.ACPTOAPI_ENABLE_ACP_AUTOLAUNCH !== '0') {
        try {
