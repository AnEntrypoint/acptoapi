...
const CMDS = {
    kilo: {
        ...
        attempts: process.env.KILO_ACP_CMD
            ...
            : [
                { command: 'bun', args: ['x', 'kilo-code-cli'] },
                { command: 'npx', args: ['--yes', 'kilo-code-cli'] },
    ...
    opencode: {
        ...
        attempts: process.env.OPENCODE_ACP_CMD
            ...
            : [
                { command: 'bun', args: ['x', 'opencode-ai'] },
                { command: 'npx', args: ['--yes', 'opencode-ai'] },
                { command: 'opencode-acp', args: ['acp'] },
    ...
    'gemini-cli': {
        ...
        attempts: process.env.GEMINI_CLI_ACP_CMD
            ...
            : [
                ...
                { command: 'bun', args: ['x', 'gemini-cli'] },
                { command: 'npx', args: ['--yes', 'gemini-cli'] },
            ],
    },
    'qwen-code': {
        port: 4820,
        attempts: process.env.QWEN_CODE_ACP_CMD
            ...
            : [
                { command: 'bun', args: ['x', 'qwen-code-cli'] },
                { command: 'npx', args: ['--yes', 'qwen-code-cli'] },
    ...
    'codex-cli': {
        ...
        attempts: process.env.CODEX_CLI_ACP_CMD
            ...
            : [
                { command: 'bun', args: ['x', 'openai-codex-cli'] },
                { command: 'npx', args: ['--yes', 'openai-codex-cli'] },
    ...
    'copilot-cli': {
        ...
        attempts: process.env.COPILOT_CLI_ACP_CMD
            ...
            : [
                ...
                { command: 'bun', args: ['x', '@github/copilot-cli'] },
                { command: 'npx', args: ['--yes', '@github/copilot-cli'] },
            ],
    },
    'cline': {
        port: 4850,
        attempts: process.env.CLINE_ACP_CMD
            ...
            : [
                { command: 'bun', args: ['x', 'cline'] },
                { command: 'npx', args: ['--yes', 'cline'] },
                { command: 'cline', args: [] },
            ],
    },
    'hermes-agent': {
        ...
        attempts: process.env.HERMES_ACP_CMD
            ...
            : [
                { command: 'bun', args: ['x', '@nos/hermes-agent'] },
                { command: 'npx', args: ['--yes', '@nos/hermes-agent'] },
            ],
    },
    'cursor-acp': {
        port: 4870,
        attempts: process.env.CURSOR_ACP_CMD
            ...
            : [
                { command: 'bun', args: ['x', 'cursor-acp'] },
                { command: 'npx', args: ['--yes', 'cursor-acp'] },
    ...
    'codeium-cli': {
        ...
        attempts: process.env.CODEIUM_ACP_CMD
            ...
            : [
                ...
                { command: 'bun', args: ['x', 'codeium-cli'] },
                { command: 'npx', args: ['--yes', 'codeium-cli'] },
            ],
    },
    'acp-cli': {
        port: 4890,
