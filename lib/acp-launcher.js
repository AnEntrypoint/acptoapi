...
const CMDS = {
    kilo: {
        ...
        attempts: process.env.KILO_ACP_CMD
            ...
            : [
                { command: 'bun', args: ['x', '@agentclientprotocol/claude-agent-acp'] },
    ...
    'qwen-code': {
        ...
        attempts: process.env.QWEN_CODE_ACP_CMD
            ...
            : [
                { command: 'bun', args: ['x', 'qwen-code'] },
                { command: 'npx', args: ['--yes', 'qwen-code'] },
            ],
    },
    'codex-cli': {
        port: 4830,
        attempts: process.env.CODEX_CLI_ACP_CMD
            ...
            : [
                { command: 'bun', args: ['x', '@zed-industries/codex-acp'] },
                { command: 'npx', args: ['--yes', '@zed-industries/codex-acp'] },
                { command: 'bun', args: ['x', '@agentclientprotocol/codex-acp'] },
